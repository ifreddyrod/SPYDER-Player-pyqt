...
"")
        ...
        spacerItem3 = QtWidgets.QSpacerItem(90, 20, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        self.CloseCaption_button = QtWidgets.QPushButton(parent=self.gridLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.CloseCaption_button.sizePolicy().hasHeightForWidth())
        self.CloseCaption_button.setSizePolicy(sizePolicy)
        self.CloseCaption_button.setMinimumSize(QtCore.QSize(40, 25))
        self.CloseCaption_button.setFocusPolicy(QtCore.Qt.FocusPolicy.ClickFocus)
        self.CloseCaption_button.setText("")
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/icons/close-caption.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon10.addPixmap(QtGui.QPixmap(":/icons/icons/close-caption-disabled.png"), QtGui.QIcon.Mode.Disabled, QtGui.QIcon.State.Off)
        self.CloseCaption_button.setIcon(icon10)
        self.CloseCaption_button.setIconSize(QtCore.QSize(20, 20))
        self.CloseCaption_button.setCheckable(True)
        self.CloseCaption_button.setObjectName("CloseCaption_button")
        self.gridLayout.addWidget(self.CloseCaption_button, 0, 6, 1, 1)
